...
private[debug] final class DelegatingDebugClient extends IDebugProtocolClient {
  var underlying: IDebugProtocolClient =
    DelegatingDebugClient.noopClient

  override def initialized(): Unit =
    underlying.initialized()
...
object DelegatingDebugClient {
  private val noopClient = new IDebugProtocolClient {}
}
